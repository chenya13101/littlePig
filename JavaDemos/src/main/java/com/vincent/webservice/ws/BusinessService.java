 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://webservice.vincent.com/ws", wsdlLocation = "http://localhost:9527/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.vincent.com/ws", "BusinessService");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://webservice.vincent.com/ws", "businessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.vincent.com/ws", "businessPort"), Business.class, features);
    }
